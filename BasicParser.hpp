...
/**
 ** \file BasicParser.hpp
 ** Define the basic::parser class.
 */
...
#ifndef YY_YY_BASICPARSER_HPP_INCLUDED
# define YY_YY_BASICPARSER_HPP_INCLUDED
...
switch (yykind)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_GOSUB ()
      {
        return symbol_type (token::GOSUB);
      }
#else
      static
      symbol_type
      ...
      make_CLEAR ()
      {
        return symbol_type (token::CLEAR);
      }
#else
      static
      symbol_type
...
#line 1528 "BasicParser.hpp"




#endif // !YY_YY_BASICPARSER_HPP_INCLUDED
